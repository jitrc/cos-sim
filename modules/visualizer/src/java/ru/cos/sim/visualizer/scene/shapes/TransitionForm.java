...
public class TransitionForm extends AbstractItem implements ITrafficLight{
	...
	protected ru.cos.sim.visualizer.trace.item.base.TrafficLight.Color currentColor;
	...
	public TransitionForm() {
		...
		this.currentColor = ru.cos.sim.visualizer.trace.item.base.TrafficLight.Color.None;
	}
	...
	@Override
	public void switchLight(ru.cos.sim.visualizer.trace.item.base.TrafficLight.Color color) {
	...
	@Override
	public ru.cos.sim.visualizer.trace.item.base.TrafficLight.Color getLightColor() {
