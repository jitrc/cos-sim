...
import ru.cos.nissan.graphs.integrator.FloatComparator;
...
class Chart {
    ...
    private static class XYDatasetCreator implements IDatasetCreator{
        ...
        public XYDataset createDataset(PointCollection pointCollection) {
            ...
            for(ru.cos.nissan.graphs.classes.Point p : pointCollection.getPoints()){
    ...
    private static class XYZDatasetCreator implements IDatasetCreator{
        ...
        public XYDataset createDataset(PointCollection pointCollection) {
            ...
            for(int i = 0; i < pointCount; i++){
                ru.cos.nissan.graphs.classes.Point p = pointCollection.getPoints().get(i);
                data[0][i] = p.getX();
                data[1][i] = p.getY();
                data[2][i] = p.getZ();
            }
