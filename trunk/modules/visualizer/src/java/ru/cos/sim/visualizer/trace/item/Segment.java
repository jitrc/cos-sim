...
import ru.cos.sim.visualizer.traffic.parser.trace.Segment.SegmentType;
...
public class Segment extends StaticEntity {
	...
	public Segment(ru.cos.sim.visualizer.traffic.parser.trace.Segment segment,Link link) {
		super(segment.id());
